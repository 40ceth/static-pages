var originalNumber=1010.2345688;

// 1010.2345688  trun  1010.23457  1010.2346  1.0102345688*10^3
var msg="<h2>originalNumber</h2>"+originalNumber+"<h2>toFixed()</h2><p>"+originalNumber.toFixed(5)+"</p><h2>toPrecision()</h2><p>"+originalNumber.toPrecision(1)+"</p>";
msg+="<h2>isNaN()</h2><p>"+isNaN(originalNumber)+"</p><h2>toExponential()</h2><p>"+originalNumber.toExponential()+"</p>";
